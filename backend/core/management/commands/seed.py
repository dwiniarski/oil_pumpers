...
class SeedCommand(BaseCommand):
    ...
    def populate_factory_types(self):
        FactoryType.objects.create(pk=FactoryTypeEnum.DRILL_FACTORY.value,
                                   ...
                                   level_upkeep_factor=config.DRILL_FACTORY_LEVEL_UPKEEP_FACTOR,
                                   level_production_factor=config.DRILL_FACTORY_LEVEL_PRODUCTION_FACTOR)
        FactoryType.objects.create(pk=FactoryTypeEnum.PUMP_FACTORY.value,
                                   ...
                                   level_upkeep_factor=config.PUMP_FACTORY_LEVEL_UPKEEP_FACTOR,
                                   level_production_factor=config.PUMP_FACTORY_LEVEL_PRODUCTION_FACTOR)
        FactoryType.objects.create(pk=FactoryTypeEnum.PIPE_FACTORY.value,
                                   ...
                                   level_upkeep_factor=config.PIPE_FACTORY_LEVEL_UPKEEP_FACTOR,
                                   level_production_factor=config.PIPE_FACTORY_LEVEL_PRODUCTION_FACTOR)
        FactoryType.objects.create(pk=FactoryTypeEnum.WAGON_FACTORY.value,
                                   ...
                                   level_upkeep_factor=config.WAGON_FACTORY_LEVEL_UPKEEP_FACTOR,
                                   level_production_factor=config.WAGON_FACTORY_LEVEL_PRODUCTION_FACTOR)
        FactoryType.objects.create(pk=FactoryTypeEnum.STORAGE_TANK_FACTORY.value,
                                   ...
                                   level_upkeep_factor=config.STORAGE_FACTORY_LEVEL_UPKEEP_FACTOR,
                                   level_production_factor=config.STORAGE_FACTORY_LEVEL_PRODUCTION_FACTOR)
